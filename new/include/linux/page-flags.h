...
enum pageflags {
/*
指定了页是否锁定。如果该比特位置位，内核的其他部分不允许访问该页。
...
*/
	PG_slab,
/*
页面的所有者使用，如果是 pagecache 页面，文件系统可能使用	
*/
...
private字段指向struct buffer_head
如果page中的private成员非空，则需要设置该标志, 用于I/O的页可使用该字段将页细分为多核缓冲区
     */
	PG_private,		/* If pagecache, has fs-private data */
/*
如果是 pagecache ，可能包含fs aux data	
*/
...
/*
    在内核决定回收某个特定的页之后，需要设置 PG_reclaim 标志通知
*/
...
/*
该page被锁住，不能交换，并会出现在LRU_UNEVICTABLE链表中，
