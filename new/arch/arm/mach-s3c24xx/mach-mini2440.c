...
/*
"at24c08" 将来用于跟i2c_driver 进行match，0x50 是at24c08的器件地址
*/
...
static struct platform_device *mini2440_devices[] __initdata = {
	...
	&s3c_device_wdt,
    /*
    这是一个platform_device，会导致adapter 的probe 被调动
    */
	&s3c_device_i2c0,
	&s3c_device_rtc,
...
static void __init mini2440_init(void)
{
    ...
    /*
    将mini2440_i2c_devs的地址赋值给mini2440_i2c_devs的dev.platform_data 成员
    */
